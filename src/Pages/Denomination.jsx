...
const Denomination = () => {
    const [message,setMessage]=useState('Error! Selected Denomination not available')
  ...
  return (
    <>
        <div style={{display:'block',margin:'0',}}>
            ...
            <div style={{textAlign:'right',marginRight:'5%',fontWeight:'bold'}}>Total Amount : {Total}</div>
            ...
            <div style={{display:'flex',justifyContent:'right'}}>
                ...
                <div style={{backgroundColor:'#0E77BD',width:'200px',display:'flex',justifyContent:'center',alignItems:'center',height:'40px',color:'white'}}>Proceed</div>
            </div>
        </div>
